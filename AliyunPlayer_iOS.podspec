#
#  Be sure to run `pod spec lint AliyunPlayer_iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "初末" => "wk132544@alibaba-inc.com" }
  # Or just: s.author    = "初末"
  # s.authors            = { "初末" => "wk132544@alibaba-inc.com" }
  # s.social_media_url   = "http://twitter.com/初末"
